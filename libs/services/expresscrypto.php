...
class ExpressCrypto
{
    protected $api_key;
    protected $currency;
    protected $api_base = 'https://expresscrypto.io/public-api/v1/';
    protected $api_base_v2 = 'https://expresscrypto.io/public-api/v2/';
